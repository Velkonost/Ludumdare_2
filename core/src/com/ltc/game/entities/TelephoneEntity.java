 ...
 * @author Velkonost
 */
public class TelephoneEntity extends Actor {
    ...
    public TelephoneEntity(Texture texture, World world, float x, float y, float widht, float higth, float dwidth, float dheight){
